"""Testes do núcleo Volume Profile: distribuição de volume, POC e Value Area (70%)."""
...
def test_poc_at_highest_volume_price():
    # Três barras concentrando volume em torno de 100.
    ...
    # O POC deve cair perto de 100 (onde a barra de maior volume concentra).
...
def test_value_area_captures_roughly_target_volume():
    # Histograma gaussiano: a VA de 70% deve capturar ~70% do volume (com tolerância de binning).
